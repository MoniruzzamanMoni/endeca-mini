...
export class AdminComponent implements OnInit {
  ...
  constructor(
    ...
    this.initialOptions = [
      ...
      new NavigationOption(4293599285, 'Tables'),
      new NavigationOption(4293592280, 'Country Tax Guides'),
      new NavigationOption(4293590545, 'Global topics'),
      new NavigationOption(4293590545, 'Treaties & Models'),
      new NavigationOption(4293588598, 'Primary Sources'),
      new NavigationOption(4293594063, 'Case Law'),
    ];
  }
  ...
  private loadInitQuery() {
    this.endecapodService.setName('AdminEndecaService');
    this.endecapodService.setURL("/endecapod", "/endecapod/my");
  ...
  doSearch(id?: number, reset = false){
    ...
    this.endecapodService.setPath('admin')
